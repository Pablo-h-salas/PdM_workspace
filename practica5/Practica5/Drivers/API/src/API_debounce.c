...
//static uint16_t button = GPIO_PIN_13;
...
void debounceFSM_update(){
	switch(estadoActual){
		case BUTTON_UP:
			...
			if (HAL_GPIO_ReadPin(PORTbUTTON, PINbUTTON)==GPIO_PIN_SET){
		...
		case BUTTON_DOWN:
			...
			if (HAL_GPIO_ReadPin(PORTbUTTON, PINbUTTON)==GPIO_PIN_RESET){
